      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex gap-5 overflow-x-auto pb-3">
          {items.map((restaurant) => (
            <Link key={restaurant.id} to={`/restaurant/${restaurant.restaurant_code}`} className="min-w-[280px] max-w-[280px] rounded-2xl border bg-white shadow-sm transition hover:-translate-y-1">
              ...
              <div className="p-5">
                ...
                <p className={`mt-2 text-xs font-semibold ${restaurant.is_open ? 'text-[#16A34A]' : 'text-red-600'}`}>{restaurant.is_open ? 'Open now' : 'Closed'}</p>
...
export function LandingPage() {
  ...
  return (
    <div className="landing-page relative">
      <section className="landing-hero relative overflow-hidden bg-gradient-to-br from-[#22C55E]/10 via-white to-[#F97316]/5 dark:bg-black dark:from-black dark:via-black dark:to-black dark:text-white">
