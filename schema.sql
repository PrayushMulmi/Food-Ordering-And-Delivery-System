...
CREATE TABLE IF NOT EXISTS restaurants (
  ...
  price_level VARCHAR(20) DEFAULT 'Medium',
...
(1, 3, 'Annaya Kitchen', 'Annaya Kitchen serves fresh multi cuisine food with quick delivery across Kathmandu.', 'Multi Cuisine', 'Kathmandu', '981110001', NULL, NULL, JSON_ARRAY(), 'Medium', 4.25, 1, 'active'),
(2, 4, 'Himalayan Spice Hub', 'Himalayan Spice Hub serves fresh indian food with quick delivery across Lalitpur.', 'Indian', 'Lalitpur', '981110002', NULL, NULL, JSON_ARRAY(), 'Medium', 4.4, 1, 'active'),
(3, 5, 'Momo Junction', 'Momo Junction serves fresh nepali food with quick delivery across Bhaktapur.', 'Nepali', 'Bhaktapur', '981110003', NULL, NULL, JSON_ARRAY(), 'Low', 4.55, 1, 'active'),
(4, 6, 'Pasta House Nepal', 'Pasta House Nepal serves fresh italian food with quick delivery across Kathmandu.', 'Italian', 'Kathmandu', '981110004', NULL, NULL, JSON_ARRAY(), 'High', 4.7, 1, 'active'),
(5, 7, 'Sakura Bowl', 'Sakura Bowl serves fresh japanese food with quick delivery across Lalitpur.', 'Japanese', 'Lalitpur', '981110005', NULL, NULL, JSON_ARRAY(), 'High', 4.1, 1, 'active'),
(6, 8, 'Dragon Wok', 'Dragon Wok serves fresh chinese food with quick delivery across Kathmandu.', 'Chinese', 'Kathmandu', '981110006', NULL, NULL, JSON_ARRAY(), 'Medium', 4.25, 1, 'active'),
(7, 9, 'Biryani Street', 'Biryani Street serves fresh indian food with quick delivery across Bhaktapur.', 'Indian', 'Bhaktapur', '981110007', NULL, NULL, JSON_ARRAY(), 'Medium', 4.4, 1, 'active'),
(8, 10, 'Fresh Greens Cafe', 'Fresh Greens Cafe serves fresh healthy food with quick delivery across Kathmandu.', 'Healthy', 'Kathmandu', '981110008', NULL, NULL, JSON_ARRAY(), 'Medium', 4.55, 1, 'active'),
(9, 11, 'Burger Barn KTM', 'Burger Barn KTM serves fresh fast food food with quick delivery across Lalitpur.', 'Fast Food', 'Lalitpur', '981110009', NULL, NULL, JSON_ARRAY(), 'Low', 4.7, 1, 'active'),
(10, 12, 'Tandoori Flame', 'Tandoori Flame serves fresh indian food with quick delivery across Kathmandu.', 'Indian', 'Kathmandu', '981110010', NULL, NULL, JSON_ARRAY(), 'High', 4.1, 1, 'active'),
(11, 13, 'Pho Valley', 'Pho Valley serves fresh vietnamese food with quick delivery across Lalitpur.', 'Vietnamese', 'Lalitpur', '981110011', NULL, NULL, JSON_ARRAY(), 'Medium', 4.25, 1, 'active'),
(12, 14, 'Wrap Station', 'Wrap Station serves fresh mediterranean food with quick delivery across Bhaktapur.', 'Mediterranean', 'Bhaktapur', '981110012', NULL, NULL, JSON_ARRAY(), 'Low', 4.4, 1, 'active'),
(13, 15, 'Pizza Peak', 'Pizza Peak serves fresh italian food with quick delivery across Kathmandu.', 'Italian', 'Kathmandu', '981110013', NULL, NULL, JSON_ARRAY(), 'Medium', 4.55, 1, 'active'),
(14, 16, 'Sekuwa Stories', 'Sekuwa Stories serves fresh nepali food with quick delivery across Lalitpur.', 'Nepali', 'Lalitpur', '981110014', NULL, NULL, JSON_ARRAY(), 'Medium', 4.7, 1, 'active'),
(15, 17, 'Kebab Corner', 'Kebab Corner serves fresh middle eastern food with quick delivery across Kathmandu.', 'Middle Eastern', 'Kathmandu', '981110015', NULL, NULL, JSON_ARRAY(), 'Medium', 4.1, 1, 'active'),
(16, 18, 'Ramen Room', 'Ramen Room serves fresh japanese food with quick delivery across Bhaktapur.', 'Japanese', 'Bhaktapur', '981110016', NULL, NULL, JSON_ARRAY(), 'High', 4.25, 1, 'active'),
(17, 19, 'Thakali Bhansa', 'Thakali Bhansa serves fresh nepali food with quick delivery across Kathmandu.', 'Nepali', 'Kathmandu', '981110017', NULL, NULL, JSON_ARRAY(), 'Medium', 4.4, 1, 'active'),
(18, 20, 'Taco Tales', 'Taco Tales serves fresh mexican food with quick delivery across Lalitpur.', 'Mexican', 'Lalitpur', '981110018', NULL, NULL, JSON_ARRAY(), 'Medium', 4.55, 1, 'active'),
(19, 21, 'Coffee Crumb', 'Coffee Crumb serves fresh cafe food with quick delivery across Kathmandu.', 'Cafe', 'Kathmandu', '981110019', NULL, NULL, JSON_ARRAY(), 'Low', 4.7, 1, 'active'),
(20, 22, 'Ocean Grill', 'Ocean Grill serves fresh seafood food with quick delivery across Bhaktapur.', 'Seafood', 'Bhaktapur', '981110020', NULL, NULL, JSON_ARRAY(), 'High', 4.1, 1, 'active');
